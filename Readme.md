...
> [!Note]
> (*) Due to limitations of using free tier of azure services, the database pauses when not used. Before using this, please first try out the "Get all products" endpoint to wake it up. 
